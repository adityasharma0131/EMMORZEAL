...
document.addEventListener("DOMContentLoaded", () => {
  for (let i = 1; i <= 5; i++) {
    ...
    // Debug: Check if selectors found the elements
    console.log(`Progress bar ${i}:`, progressBar);
    console.log(`Value container ${i}:`, valueContainer);
    
    if (!progressBar || !valueContainer) {
      console.error(`Progress bar ${i} or value container ${i} not found.`);
      continue; // Skip to the next iteration if elements not found
    }
